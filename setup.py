...
long_description = "github actions related utilities"
...
setup_kwargs["name"] = "lib_github_actions"
setup_kwargs["version"] = "v0.0.1"
setup_kwargs["url"] = "https://github.com/bitranox/lib_github_actions"
setup_kwargs["packages"] = find_packages()
setup_kwargs["package_data"] = {
    "lib_github_actions": ["py.typed", "*.pyi", "__init__.pyi"]
}
setup_kwargs["description"] = "github actions related utilities"
...
setup_kwargs["entry_points"] = {
    "console_scripts": [
        "lib_github_actions = lib_github_actions.lib_github_actions_cli:cli_main"
    ]
}
